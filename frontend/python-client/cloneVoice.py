...
DEFAULT_PREFERRED_NAME = "Arknights_shu"
DEFAULT_AUDIO_MIME_TYPE = "audio/mpeg"
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
VOICE_FILE_PATH = os.path.join(BASE_DIR, "characters\\shu\\shu.mp3")
...
def create_voice(
    ...
    """
    声音复刻过程
    这里相当于把你自己的音频文件传上去，云端给你做一些处理，比如编码，最后voice = resp.json()["output"]["voice"]返回的是一个 voice id。
    """
